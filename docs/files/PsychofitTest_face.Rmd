...
morph_levels <- c(0.15, 0.30, 0.45, 0.60, 0.75) # morph
#cprop <- c(0.5, 0.82, 0.8, 0.83, 0.9) # seq(0, 4, .01)
nYes <- c(126, 143, 165, 174, 173)
n <- c(192, 192, 192, 192, 192)
...
myData2 <- myData %>% mutate(nYes= c(126, 141, 140, 162, 169), condition = 'AS')
myData2
