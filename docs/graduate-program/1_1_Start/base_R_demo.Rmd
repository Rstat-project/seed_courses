...
> 下載這份檔案並以Rstudio開啟，按下編輯視窗上方的`Knit`按鈕，生成網頁檔有最佳瀏覽效果。

> 講義範例來自[R基本實作秘訣速查表](https://scgeeker.github.io/Reproducible_STAT/cheatsheets/base-r-TC.pdf)，部分參考[Rstudio視覺介面](https://scgeeker.github.io/Reproducible_STAT/cheatsheets/rstudio-ide-TC.pdf)以及[Rmarkdown秘訣速查表](https://scgeeker.github.io/Reproducible_STAT/cheatsheets/rmarkdown-2.0-TC.pdf)。請參考youtube的[可重製統計示範系列](https://youtube.com/playlist?list=PLSxoRcsvTAqBwSuTKEE7cOU0cSAm42gtI)，學習講義的每道範例。

> 這份講義介紹的語法及技巧涵蓋[Psyteachr課程](https://psyteachr.github.io/)的[Level 1: Data Skills](https://psyteachr.github.io/data-skills/)全書以及[Fundamentals of Quantitative Analysis](https://psyteachr.github.io/quant-fun-v2/)的第1至第8單元，提供修習"研究生學習模組"與"高年級大學生學習模組"的學員搭配學習。
...
library(tidyverse)
read_csv(file = "https://scgeeker.github.io/Reproducible_STAT/data/5factor.csv")
```
...
比照以上的示範，自由測試[秘訣速查表](https://scgeeker.github.io/Reproducible_STAT/cheatsheets/base-r-TC.pdf)列出的其他機率函式：卜瓦松分佈,二項分佈,均勻分佈。
...
比照以上的示範，嘗試視覺化[秘訣速查表](https://scgeeker.github.io/Reproducible_STAT/cheatsheets/base-r-TC.pdf)列出的其他機率函式：卜瓦松分佈,二項分佈,均勻分佈。
